...
function downloadPage() {
  ...
  {/* Sidebar: Quick anchor links */}
  <div className='w-1/4 pl-10 pt-5 text-sm border-r-2 space-y-4'>
  ...
  {/* Right side: Actual download blocks with matching IDs */}
  <div className='w-3/4 pl-8 py-6'>
    {isLoading ? (

...
const Highlights: React.FC = () => {
  return (
    <div className="md:max-w-6xl mx-auto px-4 py-20 mt-20 sm:mt-120 lg:mt-25">
      <h2 className="text-5xl lg:text-4xl mb-8 border-l-4 border-gray-300 pl-4 dark:text-white">
